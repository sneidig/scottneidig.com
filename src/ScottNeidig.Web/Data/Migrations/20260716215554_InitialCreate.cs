        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MarkdownBody = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProjectPoints_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlogPosts_Published_PublishedUtc",
                table: "BlogPosts",
                columns: new[] { "Published", "PublishedUtc" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectPoints_ProjectId",
                table: "ProjectPoints",
                column: "ProjectId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Projects_Published_SortOrder",
                table: "Projects",
                columns: new[] { "Published", "SortOrder" });
